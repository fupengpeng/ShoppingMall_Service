	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (user != null) {
				...
				getUserInfoResult.setCode(SUCCESS);
				getUserInfoResult.setInfo("info");
				getUserInfoResult.setUser(user);
				String jsonObject = JSONObject.toJSONString(getUserInfoResult);
				...
				getUserInfoResult.setCode(ERROR);
				getUserInfoResult.setInfo("infomao");
				String jsonObject = JSONObject.toJSONString(getUserInfoResult);
